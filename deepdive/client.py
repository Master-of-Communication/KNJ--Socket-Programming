...
def request_unban(name):
    client.send(f'/unban {name}'.encode('ascii'))
    # Hier könntest du eine Bestätigung oder eine Benachrichtigung für den Benutzer implementieren
